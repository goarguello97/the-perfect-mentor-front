  ...
  return (
    <>
      <form
        ...
        className="p-2! border-t border-[#444444] md:hidden flex fixed w-[calc(100%-20px)] left-1/2 -translate-x-1/2 h-[50px] bottom-[82px] bg-white z-50"
      >
        <input
